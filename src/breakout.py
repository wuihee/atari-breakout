...
class ObjectTimer(object):
    def __init__(self):
        ...
        self.wanted_time = time.clock() + self.sec
...
class ColorSettings(object):
    def __init__(self):
        ...
        self.color_dict.keys()[0].pressed = True  # Make sure the first button is pressed
    ...
    def update(self):
        buttons = self.color_dict.keys()  # List of buttons
        for b in buttons:
            if b.hover():
